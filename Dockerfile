...
RUN R -e 'remotes::install_github("r-lib/remotes", ref = "9b5dc29102a486df2f42c88bb19027a7cd54a721")'
RUN Rscript -e 'remotes::install_version("config",upgrade="never", version = "0.3")'
RUN Rscript -e 'remotes::install_version("golem",upgrade="never", version = "0.2.0")'
...
EXPOSE 80
CMD R -e "options('shiny.port'=80,shiny.host='0.0.0.0');KubeShiny::run_app()"
